...
export const unitCurrency : SystemEntity = {"category":"Amounts with Units","name":"sys.unit-currency","description":"Number + currency name","returns":"Object: amount integer + <br>currency String in <br>ISO 4217 format","default":"5 dollars"}
...
export const percentage : SystemEntity = {"category":"Amounts with Units","name":"sys.percentage","description":"Number + percents","returns":"String","default":"50%"}

export const temperature : SystemEntity = {"category":"Amounts with Units","name":"sys.temperature","description":"Number + temperature units","returns":"Object: amount integer + <br>unit String","default":"25°F"}

export const duration : SystemEntity = {"category":"Amounts with Units","name":"sys.duration","description":"Number + duration units (hours, days, months etc.)","returns":"Object: amount integer + <br>unit String","default":"10 minutes"}

export const age : SystemEntity = {"category":"Amounts with Units","name":"sys.age","description":"Number + age units (years old, months old etc.)","returns":"Object: amount integer + <br>unit String","default":"5 y.o."}

export const currencyName : SystemEntity = {"category":"Unit Names","name":"sys.currency-name","description":"Currencies","returns":"String in <br>ISO 4217 format","default":"dollars"}
...
export const zipCode : SystemEntity = {"category":"Geography","name":"sys.zip-code","description":"United States,<br>Great Britain,<br>Canada postal codes","returns":"String","default":"94122"}

export const geoCapital : SystemEntity = {"category":"Geography","name":"sys.geo-capital","description":"World capitals","returns":"String in English","default":"Paris"}

export const geoCountry : SystemEntity = {"category":"Geography","name":"sys.geo-country","description":"Short and full names of country","returns":"String in English","default":"United States"}

export const geoCountryCode : SystemEntity = {"category":"Geography","name":"sys.geo-country-code","description":"Short and full country names, alpha-2, alpha-3 and numeric codes as per <br>ISO 3166-1","returns":"object: Strings for name, <br>alpha-2 and alpha-3 codes, <br>integer for numeric code <br>as per ISO 3166-1","default":"United Sates"}

export const geoCity : SystemEntity = {"category":"Geography","name":"sys.geo-city","description":"Major cities","returns":"String in English","default":"New York"}

export const geoState : SystemEntity = {"category":"Geography","name":"sys.geo-state","description":"Major states in GB, USA, India, Canada, Australia.","returns":"String in English","default":"CA"}

export const placeAttraction : SystemEntity = {"category":"Geography","name":"sys.place-attraction","description":"Top tourist attractions","returns":"String in English","default":"Golden Gate Bridge"}

export const airport : SystemEntity = {"category":"Geography","name":"sys.airport","description":"Airport names, IATA and ICAO codes","returns":"Object: Strings for country, <br>city of the airport, its name <br>and its IATA/ICAO codes","default":"Heathrow Airport"}
...
export const email : SystemEntity = {"category":"Contacts","name":"sys.email","description":"email","returns":"String","default":"user@example.com"}

export const phoneNumber : SystemEntity = {"category":"Contacts","name":"sys.phone-number","description":"Phone number","returns":"String of phone number<br>(spaces, dashes and <br>parentheses are omitted)","default":"(123) 456 7890"}

export const givenName : SystemEntity = {"category":"Names","name":"sys.given-name","description":"<span style=\"color:red\">Deprecated</span>: Use @sys.person instead.<br>Common given names","returns":"String","default":"John"}

export const lastName : SystemEntity = {"category":"Names","name":"sys.last-name","description":"<span style=\"color:red\">Deprecated</span>: Use @sys.person instead.<br>Common last names","returns":"String","default":"Smith"}

export const person : SystemEntity = {"category":"Names","name":"sys.person","description":"Common given names, last names or their combinations","returns":"Object: name string","default":"Mary Smith"}

export const musicArtist : SystemEntity = {"category":"Music","name":"sys.music-artist","description":"Matches an artist / group name","returns":"String","default":"Beatles"}
...
export const color : SystemEntity = {"category":"Other","name":"sys.color","description":"Words describing colors","returns":"String","default":"green"}

export const language : SystemEntity = {"category":"Other","name":"sys.language","description":"Language names","returns":"String","default":"English"}
